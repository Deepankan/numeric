class SiteSettingsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @site_setting.save
        format.html { redirect_to site_settings_path, notice: 'Site setting was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @site_setting.update(site_setting_params)
        format.html { redirect_to site_settings_path, notice: 'Site setting was successfully updated.' }
  ...
  private
    ...
    def site_setting_params
      params.require(:site_setting).permit(:api_client_id, :api_key)
    end
end
