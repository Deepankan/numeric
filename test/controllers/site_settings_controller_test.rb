...
class SiteSettingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create site_setting" do
    assert_difference('SiteSetting.count') do
      post site_settings_url, params: { site_setting: { api_client_id: @site_setting.api_client_id, api_key: @site_setting.api_key } }
    end
  ...
  test "should update site_setting" do
    patch site_setting_url(@site_setting), params: { site_setting: { api_client_id: @site_setting.api_client_id, api_key: @site_setting.api_key } }
